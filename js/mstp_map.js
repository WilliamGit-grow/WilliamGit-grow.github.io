...
var bar_datas = {
                  'xining':[{data : bar_data1,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data2,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data3,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],

                  'haibei':[{data : bar_data4,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data5,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data6,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],

                  'haidong':[{data : bar_data7,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data8,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data9,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],
                  'haixi':[{data : bar_data10,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data11,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data12,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],

                  'hainan':[{data : bar_data13,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data14,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data15,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],

                  'yushu':[{data : bar_data16,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data17,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data18,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],

                  'huangnan':[{data : bar_data19,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data20,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data21,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}],

                  'guoluo':[{data : bar_data22,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data23,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}},
                            {data : bar_data24,label: '温度正常',bars : {show : true, barWidth : 0.3, order : 1,fill:1,lineWidth: 0,fillColor: 'rgba(255,255,255,0.6)'}}]
                };
...
$(function(){
    var pieData = [
                    {data: 1, color: 'rgba(255,200,255,0.8)',label:'温度异常'},
                    {data: 2, color: 'rgba(255,255,200,0.8)',label:'湿度异常'},
                    {data: 3, color: 'rgba(200,200,255,0.8)',label:'未检测出'},
                    {data: 4, color: 'rgba(200,0,200,0.8)',label:'温湿度正常'}

                ];
    var donutPieData = [
        {data: 1, color: 'rgba(255,0,0,0.8)',label:'超速'},
        {data: 2, color: 'rgba(200,200,255,0.8)',label:'未检测出'},
        {data: 3, color: 'rgba(0,255,0,0.8)',label:'未超速'}
    ];
    if($('#donut-chart')[0]){
