    ...
    var settings =  '<a id="settings" href="#changeSkin" data-toggle="modal">' +
			...
			'<div class="modal-dialog modal-lg">' +
				...
				'<div class="modal-body">' +
					...
					'<a data-skin="skin-blur-violate" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-violate.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-lights" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-lights.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-city" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-city.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-greenish" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-greenish.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-night" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-night.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-blue" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-blue.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-sunny" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-sunny.jpg" >' +
					'</a>' +
					'<a data-skin="skin-cloth" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-cloth.jpg" >' +
					'</a>' +
					'<a data-skin="skin-tectile" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-tectile.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-chrome" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-chrome.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-ocean" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-ocean.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-sunset" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-sunset.jpg" >' +
					'</a>' +
					'<a data-skin="skin-blur-yellow" class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-yellow.jpg" >' +
					'</a>' +
					'<a  data-skin="skin-blur-kiwi"class="col-sm-2 col-xs-4" >' +
					    '<img src="img/skin-kiwi.jpg" >' +
					'</a>' +
				    '</div>' +
				'</div>' +
			    '</div>' +
